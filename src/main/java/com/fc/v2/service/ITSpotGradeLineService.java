...
/**
 * 违法占用耕地面积分档线 Service接口（rule-eval 形状：规则求值，无增删改）
 *
 * @author fuce
 * @date 2026-09-14
 */
public interface ITSpotGradeLineService {

    /** 按主键查询规则 */
    TSpotGradeLine selectTSpotGradeLineById(Long id);
    ...
    List<TSpotGradeLine> listAvailable(Date at);
