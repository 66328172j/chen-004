...
/**
 * 违法占用耕地面积分档线对象 t_spot_grade_line
 *
 * @author fuce
 * @date 2026-09-12
 */
@TableName("t_spot_grade_line")
@ApiModel(value = "TSpotGradeLine", description = "违法占用耕地面积分档线")
public class TSpotGradeLine implements Serializable {
    ...
    /** 一般档违法占用比例上限(%) */
    @TableField("th1_max")
    @ApiModelProperty(value = "一般档违法占用比例上限(%)")
    private BigDecimal th1Max;

    /** 较重档违法占用比例上限(%) */
    @TableField("th2_max")
    @ApiModelProperty(value = "较重档违法占用比例上限(%)")
    private BigDecimal th2Max;

    /** 严重档违法占用比例上限(%) */
    @TableField("th3_max")
    @ApiModelProperty(value = "严重档违法占用比例上限(%)")
    ...
    /** 分档线状况 0在用 1已让位 */
    @TableField("status")
    @ApiModelProperty(value = "分档线状况 0在用 1已让位")
